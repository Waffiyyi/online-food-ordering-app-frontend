...
export const initiateResetPasswordRequest = (reqData) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(handleError(INITIATE_RESET_PASSWORD_FAILURE, error.response.data.errorMessage || error.response?.data?.message || error.message));
  }
...
export const ResetPasswordRequest = (resetRequest) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(handleError(RESET_PASSWORD_FAILURE, error.response.data.errorMessage || error.response?.data?.message || error.message));
