...
export const INITIATE_RESET_PASSWORD_REQUEST="INITIATE_RESET_PASSWORD_REQUEST";
export const INITIATE_RESET_PASSWORD_SUCCESS="INITIATE_RESET_PASSWORD_SUCCESS";
export const INITIATE_RESET_PASSWORD_FAILURE="INITIATE_RESET_PASSWORD_FAILURE";
